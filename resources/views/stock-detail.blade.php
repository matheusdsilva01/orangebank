        ...
        <div class="bg-fuchsia-200 p-6 flex flex-col gap-6 rounded-xl border col-span-2 border-gray-400 shadow-sm">
            <div class="flex items-center justify-between">
                ...
                <div class="text-right text-sm text-muted-foreground">
                    ...
                    <p>05/09/2025, 19:16:25</p>
                </div>
            </div>
        </div>
        <div class="bg-fuchsia-200 p-6 col-span-1 row-span-2 flex flex-col gap-6 rounded-xl border border-gray-400 shadow-sm">
...
{{--                {{csrf_field()}}--}}
                <div>
                    <label class="text-sm font-medium mb-2 block" for="identifier">Quantidade</label>
